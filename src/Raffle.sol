...
contract Raffle is VRFConsumerBaseV2  {
    ...
    error NotUpKeepNeeded(uint256 timestamp,
    ...
    uint32 callbackGasLimit)VRFConsumerBaseV2(vrfCoordinator_) {
        ...
        returns (bool upkeepNeeded, bytes memory /* performData */)
    {
        ...
        upkeepNeeded = timeHasPassed && raffleIsOpen && numberOfParticipants && balanceIsNotZero;
    ...
    function fulfillRandomWords(
        ...
        (bool isSuccess, ) = s_participants[winnerIndex].call{value: address(this).balance}("");
